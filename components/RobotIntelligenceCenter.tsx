    ...
    <div className="bg-white dark:bg-slate-900 border-2 border-emerald-100 dark:border-emerald-900/30 rounded-[2.5rem] shadow-xl overflow-hidden transition-all duration-300">
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="flex flex-col gap-2">
          <a
            href="https://app.punchlineroi.com"
            target="_blank"
            rel="noreferrer"
            className="w-full py-3.5 bg-emerald-600 text-white rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-emerald-700 shadow-lg shadow-emerald-100 transition-all flex items-center justify-center gap-2"
          >
