...
import { Client, CompanySize, ERPType, UserProfile } from '../types';
...
const ClientManager: React.FC = () => {
  ...
  const filteredClients = useMemo(() => {
    ...
    // Explicitly cast Object.values(clients) to Client[] to avoid 'unknown' type errors in the pipeline
    return (Object.values(clients) as Client[])
