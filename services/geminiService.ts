...
// Model
// ─────────────────────────────────────────────────────────────
const MODEL_CHECKLIST = 'gemini-2.5-pro-preview-03-25';  // Gemini 2.5 Pro — generowanie checklisty
const MODEL_CHAT = 'gemini-2.0-flash';                   // Gemini 2.0 Flash — czat (szybszy)
